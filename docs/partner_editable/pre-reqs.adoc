...
//TODO Dave, I commented out the above section since the boilerplate file planning_deployment.adoc generates an "Amazon EC2 key pairs" section whenever CloudFormation templates include EC2 instances. Do we need to restore this section?