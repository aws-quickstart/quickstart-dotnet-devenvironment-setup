...
. Sign in to your AWS account, and https://fwd.aws/dy6nb?[launch the AWS CloudFormation template^]. (https://fwd.aws/dkVjJ?"[View the template^].) For details, see link:#_deployment_options[Deployment options] earlier in this guide.
