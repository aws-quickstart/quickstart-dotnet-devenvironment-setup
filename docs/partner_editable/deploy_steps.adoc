...
NOTE: If you're deploying into an existing VPC, ensure that your VPC has a public subnet for hosting the development-tools instance. 

Each deployment takes about {deployment_time} to complete.

. Sign in to your AWS account, and http://qs_launch_permalink[launch the AWS CloudFormation template^]. (http://qs_template_permalink[View the template^].) For details, see link:#_deployment_options[Deployment options] earlier in this guide.
